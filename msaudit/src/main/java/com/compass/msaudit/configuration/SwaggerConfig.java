package com.compass.msaudit.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.compass.msaudit.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API Msaudit")
                .description("Documentação do msaudit do projeto ShopStyle")
                .version("1.0.0")
