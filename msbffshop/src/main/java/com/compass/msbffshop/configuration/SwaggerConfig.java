package com.compass.msbffshop.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.compass.msbffshop.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API Msbffshop")
                .description("Documentação do msbffshop do projeto ShopStyle")
                .version("1.0.0")
