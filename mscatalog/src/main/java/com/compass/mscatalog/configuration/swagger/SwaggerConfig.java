package com.compass.mscatalog.configuration.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.compass.mscatalog.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API Mscatalog")
                .description("Documentação do mscatalog do projeto ShopStyle")
                .version("1.0.0")
